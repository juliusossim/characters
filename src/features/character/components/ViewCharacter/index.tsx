...
import { CharacterFooter, StyledCharacterCard, StyledCharacterImage, StyledCharacterList, StyledCharacterListItem, ClippedText, BorderedText, RightBox } from "@/components/Styles/CharacterPageStyles"
...
export const ViewCharacter: FC<ViewCharacterProps> = ({ character }: ViewCharacterProps) =>  {
   ...
   const goBack = () => navigate(-1)
    ...
    return (
         <StyledCharacterCard className="group">
            <Typography size="big" variant="primary">{name?.toUpperCase()}</Typography>
           <RightBox>
