import { LeftBox, ClippedText, BorderedText } from "@/components/Styles/CharacterPageStyles";
...
export const BioData = ({hair, origin, mode}: BiodataProps): JSX.Element => {
  ...
  return (
    <FlexCol>
      <LeftBox>
      <FlexRow>
      <ClippedText size="big" variant={mode} >Origin</ClippedText>
<BorderedText size='big'>{origin}</BorderedText>
      </FlexRow>
      <FlexRow>
      <ClippedText size="big" variant={mode} >Hair Color</ClippedText>
