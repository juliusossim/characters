...
export const BorderedText = tw(
	Typography
)`border-amber-300 border-solid border-2 bg-white pl-24 py-1
pr-2 my-1 rounded-2xl ml-2
`;

export const ClippedText = tw(
	Typography
)`bg-clip-text bg-gradient-to-r from-amber-500 to-purple-400 text-transparent`;
...
export const RightBox = tw(
	motion.div
)`w-full flex justify-end p-7 bg-gradient-to-r from-transparent to-white`;
